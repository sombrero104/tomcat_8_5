...
public class Digester extends DefaultHandler2 {
    ...
    static {
    	//
    	System.out.println("org.apache.tomcat.util.digester.Digester - static start"); // test
        ...
        if (className != null) {
            ...
            for (int i = 0; i < cls.length; i++) {
            	System.out.println("org.apache.tomcat.util.digester.Digester - static - className: " + className); // test
                try {
        ...
        System.out.println("org.apache.tomcat.util.digester.Digester - static end"); // test
    }
    ...
    public SAXParser getParser() {
    	// System.out.println("org.apache.tomcat.util.digester.Digester - getParser()"); // test
    ...
    /**
     * XML 데이터를 넣으면 파싱해서 최상위 root 엘리먼트를 반환함.
    ...
    public Object parse(InputSource input) throws IOException, SAXException {
        ...
        getXMLReader().parse(input);
        /*
        System.out.println("******************************** 6 getParser() : " + getParser());
        // com.sun.org.apache.xerces.internal.jaxp.SAXParserImpl@57bb8bf8
        
        System.out.println("******************************** 6 getXMLReader() : " + getXMLReader());
        // com.sun.org.apache.xerces.internal.jaxp.SAXParserImpl$JAXPSAXParser@7d5d50c1
        
        */
        
        System.out.println("******************************** 6 parse(InputSource input) - root : " + root); // test
    ...
    public void push(Object object) {
    	System.out.println("org.apache.tomcat.util.digester.Digester - push(Object object) - object :" + object); // test
